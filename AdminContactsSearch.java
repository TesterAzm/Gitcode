/**
* Test Script Name                   : AdminContactsSearch
...
* Epic Details                       : N/A hi druva pq3wrl 
* User Story Details                 : N/A bye dhruva eeoeyq
**/
...
public class AdminContactsSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminContactsSearch";
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminContactsSearch(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangementContactsPage.verifySearchFunctionality(testdatamap,Log);
